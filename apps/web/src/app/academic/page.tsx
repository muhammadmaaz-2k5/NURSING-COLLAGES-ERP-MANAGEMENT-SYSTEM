...
export default function AcademicPage() {
  ...
  const programColumns: Column<Program>[] = [
    ...
    },
    {
      ...
      cell: (p) => (
        <div>
          ...
          <p className="text-xs text-slate-400">{p.description || 'PNC Recognized'}</p>
        </div>
      ),
    },
    {
      ...
      sortable: true,
      cell: (p) => <span className="font-medium text-slate-300">{p.durationYears} Academic Years</span>,
    },
    {
      header: 'HEC/PNC Credits',
      accessorKey: 'totalCredits',
      sortable: true,
      cell: (p) => <span className="font-mono font-bold text-purple-400">{p.totalCredits} CH</span>,
    },
    {
    ...
    },
    {
      ...
      cell: (p) => (
        <Badge variant={p.isActive ? 'success' : 'neutral'} size="sm" dot>
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <Card hoverEffect className="p-5">
          ...
          <h3 className="text-2xl font-black text-white mt-1">4</h3>
          <p className="text-xs text-blue-400 mt-2 font-medium">BSN, Post-RN, DPT, MLT</p>
        </Card>
        ...
        <Card hoverEffect className="p-5">
          ...
          <p className="text-xs text-purple-400 mt-2 font-medium">Nursing & Allied Sciences</p>
        </Card>
        ...
        <Card hoverEffect className="p-5">
          ...
          <p className="text-xs text-emerald-400 mt-2 font-medium">Allotted Class Cohorts</p>
        </Card>
        ...
        <Card hoverEffect className="p-5">
          ...
          <p className="text-xs text-amber-400 mt-2 font-medium">Simulation Labs & Halls</p>
        </Card>
      </div>
      ...
      {activeTab === 'curriculum' && (
        <CurriculumView programs={programs} subjects={subjects} />
      )}
